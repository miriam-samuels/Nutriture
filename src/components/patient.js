...
export class patient extends Component {
    render() {
        const {email,username,number,genotype,bloodgroup,height,weight,password,cpassword} = this.props;
        const {emailChange,usernameChange,numberChange,genotypeChange,bloodgroupChange,heightChange,weightChange,passwordChange,cpasswordChange,formSubmitted} = this.props;
        return (
            <div id="login">
